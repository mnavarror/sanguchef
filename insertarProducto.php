    ...
    <div class="services">
        ...
        <div class="welcome-info">
            <div class="col-md-9 col-xs-offset-3">
                <form name="formulario" method="post" action="insertarProducto.php" >
                    <table>
                        ...
                        <tr>
                            <td></td>
                            <td >
                                <input value="crear" name="crear" type="submit" class="col-xs-offset-8"/>
                            </td>
                        </tr>
                    </table>
...
if (isset($_REQUEST['crear'])) {
    $nombre = $_POST['nombre'];
    $valor = $_POST['valor'];
    $consulta = "insert into producto (nombre_producto,valor_producto,disponible_producto) values ('$nombre','$valor','1')";
    $ejecutar = mysqli_query($conectar, $consulta);

    if($ejecutar){
        print '<script language="JavaScript">';
        print 'alert("PRODUCTO CREADO EXITOSAMENTE");';
        ...
        print '<script language="JavaScript">';
        print 'alert("EL PRODUCTO NO PUDO SER CREADO");';
        print 'window.location="adminZone.php"';
        print '</script>';
    }
}
